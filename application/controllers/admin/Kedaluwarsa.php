...
class Kedaluwarsa extends CI_Controller
{
	public function __construct()
	{
		parent::__construct();
		$this->load->model("kedaluwarsa_model");
		if($this->login_model->tidakMasuk()) redirect(site_url('admin/login'));
	}

	public function index()
	{
		$data["kedaluwarsa"] = $this->kedaluwarsa_model->lihat();
		$this->load->view("admin/kedaluwarsa/kedaluwarsa", $data);
	}
